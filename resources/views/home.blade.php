...
<div class="site-wrapper">
	...
	<div class="mobile-header py-2 px-3 mt-4">
		...
		<a href="index.html" class="logo"><img src="#" alt="Bako Doe" /></a>
		<a href="index.html" class="site-title dot ml-2">Anwarsadad Arsy</a>
	</div>
	...
	<header class="left float-left shadow-dark" id="header">
		...
		<div class="header-inner d-flex align-items-start flex-column">
			<a href="index.html"><img src="images/anwar.jpg" alt="Bako Doe" /></a>
			<a href="index.html" class="site-title dot mt-3">Anwarsadad</a>
	...
	<main class="content float-right">
		...
		<section class="hero background parallax shadow-dark d-flex align-items-center" id="home" data-image-src="https://via.placeholder.com/900x600">
			<div class="cta mx-auto mt-2">
				<h1 class="mt-0 mb-4">I’m Anwarsadad<span class="dot"></span></h1>
		...
		<section id="about" class="shadow-blue white-bg padding">
			...
			<div class="row">
				<div class="col-md-3">
					<img src="images/anwar.jpg" alt="about" />
				</div>
				<div class="col-md-9">
					<h2 class="mt-4 mt-md-0 mb-4">Hello,</h2>
					<p class="mb-0">I am Anwarsadad, web developer from Pringgabaya, Indonesia. I have rich experience in web site design and building and customization, also I am good at wordpress.</p>
					<div class="row my-4">
						<div class="col-md-6">
							<p class="mb-2">Name: <span class="text-dark">Anwarsadad</span></p>
							<p class="mb-0">Birthday: <span class="text-dark">17 August, 1998</span></p>
						</div>
						<div class="col-md-6 mt-2 mt-md-0 mt-sm-2">
							<p class="mb-2">Location: <span class="text-dark">Mataram, INA</span></p>
							<p class="mb-0">Email: <span class="text-dark">Anwarsadad@home.com</span></p>
						</div>
					</div>
